...
//			for (pIndex = 0; strcmp(OLED_CF14x14[pIndex].Index, "") != 0; pIndex ++)
//			{
//				/*找到匹配的汉字*/
//				if (strcmp(OLED_CF14x14[pIndex].Index, SingleChinese) == 0)
//				{
...
//			OLED_ShowImage(X + ((i + 1) / OLED_CHN_CHAR_WIDTH - 1) * 14, Y, 14, 14, OLED_CF14x14[pIndex].Data);
//		}
//	}
//}
